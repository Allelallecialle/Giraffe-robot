...
if answer.lower() == 'vis':
    ...
    q_final, qd_final, time, time_log, p_log, p_des_log, pitch_log, pitch_des_log, q_log, qd_log, qdd_log, tau_log = run_task_simulation(robot, frame_id, ros_pub, p_des, rpy_des)
    test_simulation(robot, frame_id, p_des, rpy_des, q_final, qd_final, time)
    plot_simulation(time_log, p_log, p_des_log, pitch_log, pitch_des_log, q_log, qd_log, qdd_log, tau_log)
